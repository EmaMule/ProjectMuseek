...
<html lang="en">
  <head>
    ...
    />
    <script
      src="https://kit.fontawesome.com/d20fe07ffa.js"
  ...
  <body onload="mostranascondi();">
      ...
      <div class="container p-0">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul
              class="navbar-nav mr-auto mb-2 mb-lg-0 ml-3 justify-content-center"
              id="lista_navbar"
            >
          ...
          <a
            class="my_navbar_login"
            style="color: black; opacity: 100%"
            href="javascript:void(0);"
            onclick="see_or_unsee_form();"
            value="Login"
            ><i
              class="fa-solid fa-user-plus icona_utente"
              aria-hidden="false"
              aria-valuetext="Accedi Ora"
            ></i
          ></a>
        </nav>
    ...
    <div
      class="search-results container-fluid d-flex align-items-center justify-content-end"
      style="color: black"
    >
    ...
    <section class="forms">
      <div class="signup-box">
        <form
          name="myForm"
          id="RegisterForm"
          action="../php-function/register.php"
          method="POST"
        >
          <h1>Signup</h1>
          <div class="box">
      ...
      <div class="form login-box">
        <form id="LoginForm" action="../php-function/login.php" method="POST">
          ...
          <div class="register-link">
            <p>
              Don't have an account?<a href="#" onclick="mostraRegister();"
                >Register</a
              >
            </p>
          </div>

        ...
        <div class="section-content">
            <div class="row d-flex flex-wrap mb-3 no-gutters">
                ...
                <div class="container container-fluid">
                    ...
                    <div class="row d-flex">
                        <p>Music is an art that lets us express ourselves and connect with others, historically used to tell stories and convey emotions. Today, it continues to be a dynamic art form that reflects human experience.</p>
                    </div>
                    <div class="row d-flex">
                        <p>In the digital age, music has become more accessible than ever before, enabling anyone with talent and passion to find an audience and share their work with the world. This has created new opportunities for musicians and fans alike.</p>
                    </div>
                    <div class="row d-flex">
                        <p>Our blog celebrates the diversity of music by providing a platform for people to share their favorite songs, artists, and albums. Under the "What's new?" section, you can post your latest music discoveries, discuss your favorite genres, and connect with other music lovers from around the world. Let's make some beautiful music together!</p>
                    </div>
                </div>
                </div>
                <div class="col-lg-8">
                    ...
                    <div class="carousel__cell_top_g">
                        ...
                        <div class=" card card_cube_top_g">
                            ...
                            <div class="card-img-overlay text-black">
                                <a href="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwiAuuy1zv_9AhUahP0HHXP-BqcQFnoECA4QAQ&url=https%3A%2F%2Fwww.tmz.com%2F&usg=AOvVaw0QIdwyeMkyrNPrxkpccs0F" >

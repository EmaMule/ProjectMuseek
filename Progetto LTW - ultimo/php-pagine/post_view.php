...
<body class="body_articolo">
    ...
    <div class="container-fluid">
        ...
        <button type='button' onclick="mostraAltri();" id='more-comments-btn' class="btn btn-primary altri-commenti-btn"
            style="margin-top: 60px; margin-bottom: 60px;">More comments</button>

    ...
    <header>
        <div class="container p-0">
            <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
                <a class="navbar-brand my_brand" href="homepage.php">Music.com</a>
        ...
        <div class="row">
            ...
            <div class="col-10">
                <ul class="article_ul_top_g">
                    <li class="article_top_g article_container_top_g" id="article-0">
                        <a href="#">
                            <header class="h5 article_user_text_top_g">
                                <img class="article_little_icon_top_g" src="images/goku.jpg">User00
                            </header>
                        ...
                        <img src="images/article-img-placeholder.jpg" class="article_img_top_g" />
                        <p class="p-1 article_text_top_g">
                            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fugit,
                            aperiam laboriosam. Voluptatibus omnis provident recusandae et
                            culpa? Quisquam rem repellat voluptate. Distinctio incidunt,
                            voluptate explicabo eos laborum pariatur consectetur? Nihil?
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse
                            voluptatum quaerat, quisquam voluptatem debitis ipsa eligendi
                            vitae maxime reiciendis alias ullam, dolorem sint rem. Alias
                            quae ipsam praesentium. Repudiandae, nostrum?
                        </p>
                    </li>
                    <li class="article_top_g article_container_top_g" id="article-1">

                        <a href="#">
                            <header class="h5 article_user_text_top_g">
                                <img class="article_little_icon_top_g" src="images/Gabriele.jpeg">Gab666
                            </header>
                    ...
                    <li class="article_top_g article_container_top_g" id="article-2">
                        <a href="#">
                            <header class="h5 article_user_text_top_g">
                                <img class="article_little_icon_top_g" src="images/Simone.jpeg">Palu001
                            </header>
                    ...
                    <li class="article_top_g article_container_top_g" id="article-3">
                        <a href="#">
                            <header class="h5 article_user_text_top_g">
                                <img class="article_little_icon_top_g" src="images/Vegeta.png">RPUP1
                            </header>
                    ...
                    <li class="article_top_g article_container_top_g" id="article-4">
                        <a href="#">
                            <header class="h5 article_user_text_top_g">
                                <img class="article_little_icon_top_g" src="images/Emanuele.jpeg">Mule001
                            </header>
        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="container margin_divider">
                    ...
                    <p class="archive_text_top_g">Upload your personal content, porcamadonna. Get
                        feedback from other users and have everyone know how good you are, dio negroide in zambia.
                        Guitar, piano, saxophone. every instrument is accepted! Play here your videos and your
                        audios. Every LGBTQ+ member is accepted as well and we enforce pronoun recognition. If
                        you identify as a frocio dimmerda it's okay. This site is for everyone and there is no place for
                        hate here.

...
<body onload="mostranascondi();">
  ...
  <section class="forms">
    <div class="signup-box">
      <form name="myForm" action="./register/register.php" method="POST">
        <h1>Signup</h1>
        <div class="box">
        ...
        <div class="box">
          <i class="fa-solid fa-lock bx-hide"></i>
          <input type="password" class="password" name="inputConfirmPassword" required />
    ...
    <?php if (isset($_GET['errore'])) {
      // decodifica il messaggio di errore dalla query string
      $messaggio_errore = urldecode($_GET['errore']);
      // visualizza il messaggio di errore
      echo '<p class="errore">' . $messaggio_errore . '</p>';
    }
    ?>
  </section>

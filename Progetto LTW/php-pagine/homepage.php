...
<body class="bg-light">
    ...
    <div class="row d-flex flex-wrap mb-3 no-gutters">
        <div class="col-md-6">
            ...
            <h2 class="most_recent_top_g">WHAT DID YOUR FOLLOWERS POST? </h2>
            <div class="row">
                <ul class="lista-notizie-follower">
                    <li class="elemento_lista">
                        <img src="../images/B-writing.webp" class="immagine_articolo">
                        <a class="anchor-lista" href="#"> Four-time Grammy-winner Drake is teaming up with collaborator
                            21 Savage for a North American arena tour this year. The It's All a Blur Tour will kick off
                            June 16 in New Orleans and stop in Dallas, Miami, New York, Montreal, Los Angeles and Las
                            Vegas. Additional shows including Toronto will be announced later. The Canadian
                            rapper-singer and Spotifys most-streamed artist in the U.S. last year put out two albums in
                            2022, “Honestly, Nevermind” and his collaboration with 21 Savage, “Her Loss.” </a>
                    </li>
                    <li class="elemento_lista">
                        <img src="../images/B-writing.webp" class="immagine_articolo">
                        <a class="anchor-lista" href="#"> Four-time Grammy-winner Drake is teaming up with collaborator
                    ...
                    <li class="elemento_lista">
                        <img src="../images/B-writing.webp" class="immagine_articolo">
                        <a class="anchor-lista" href="#"> Articolo </a>
                    </li>
                    <li class="elemento_lista">
                        <img src="../images/B-writing.webp" class="immagine_articolo">
                        <a class="anchor-lista" href="#"> Articolo </a>

...
$query="SELECT * from utente,follow,articolo,media_articolo where articolo.id=media_articolo.id_articolo and utente.email=follow.seguito and follow.seguito=articolo.utente and follow.segue=$1 limit 7;";
$result=pg_query_params($dbconn, $query, array($_SESSION["email"]));
$num_rows = pg_num_rows($result);
if($num_rows>=7){
while($line = pg_fetch_array($result, null, PGSQL_ASSOC)){
    $utente_seguito=$line["username"];
    $immagine_post=pg_unescape_bytea($line["contenuto"]);
    $titolo_post=$line["titolo"];
    $descrizione_post=$line["descrizione"];
    $id=$line["id_articolo"];
    $post_follower[]=array("id"=> $id,"utente_seguito"=>$utente_seguito, "immagine_post"=>$immagine_post, "titolo_post"=>$titolo_post, "descrizione_post"=>$descrizione_post);
}
}
else{
    $query="SELECT * from utente,articolo,media_articolo where articolo.id=media_articolo.id_articolo and utente.email=articolo.utente order by utente.numfollower desc limit 7;";
    $result=pg_query($dbconn, $query);
    while($line = pg_fetch_array($result, null, PGSQL_ASSOC)){
    $utente_seguito=$line["username"];
    $immagine_post=pg_unescape_bytea($line["contenuto"]);
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                ...
                <div class="search-bar" id="search_bar">
                    <input type="text" class="search-bar-text" placeholder="Search anything" id="Search_input"
                        autocomplete="off" onkeyup="showHint(this.value)" />
    ...
    <div class="row d-flex flex-wrap mb-3 no-gutters">
        <div class="col-md-6">
                        ...
                        <div class="carousel__cell_top_g">
                            ...
                            <div class=" card card_cube_top_g">
                                ...
                                <div class="card-img-overlay text-black">
                                    <a href="./profile_view.php?user=<?php echo $utenti_follower[0]['utente'] ?>">
                        ...
                        <div class="carousel__cell_top_g">
                            <div class=" card card_cube_top_g">
                                <img class="img_cube_top_g card-img" id="img-cube-1"
                                    ...
                                    alt="Card image" />
                                <div class="card-img-overlay text-black">
                                    <a href="./profile_view.php?user=<?php echo $utenti_follower[1]['utente'] ?>">
                        ...
                        <div class="carousel__cell_top_g">
                            <div class=" card card_cube_top_g">
                                <img class="img_cube_top_g card-img" id="img-cube-2"
                                    ...
                                    alt="Card image" />
                                <div class="card-img-overlay text-black">
                                    <a href="./profile_view.php?user=<?php echo $utenti_follower[2]['utente'] ?>">
                                        <header class="nomi_utente" id="title-cube-0">
                        ...
                        <div class="carousel__cell_top_g">
                            <div class=" card card_cube_top_g">
                                <img class="img_cube_top_g card-img" id="img-cube-3"
                                    ...
                                    alt="Card image" />
                                <div class="card-img-overlay text-black">
                                    <a href="./profile_view.php?user=<?php echo $utenti_follower[3]['utente'] ?>">
                                        <header class="nomi_utente" id="title-cube-0">
            ...
            <?php if(isset($_SESSION["email"])){
                echo "<h2 class='most_recent_top_g' style='margin-bottom: 25px; margin-top: 25px;'>WHAT DID YOUR FOLLOW POST? </h2>";
            }
            else{
                echo "<h2 class='most_recent_top_g' style='margin-bottom: 25px; margin-top: 25px;'>WHAT DID THE MOST FOLLOWED POST? </h2>";
            } ?>
            <div class="row">
                <ul id="container_follow_notizie" class="lista-notizie-follower">
                    <li class="elemento_lista">
                        <img src="data:image/jpg;charset=utf8;base64,<?php echo $post_follower[0]['immagine_post'];?>" class="immagine_articolo">
                        <div class="container-fluid">
                        <span style="display:block;font-weight:bold;margin-bottom:6px;"><?php echo $post_follower[0]["titolo_post"] . ' by ' . $post_follower[0]["utente_seguito"];?></span>
                        <a class="anchor-lista" href="./post_view.php?article=<?php echo $post_follower[0]['id'];?>"><?php echo $post_follower[0]["descrizione_post"];?></a>
                        </div>
                    </li>
                    <li class="elemento_lista">
                        <img src="data:image/jpg;charset=utf8;base64,<?php echo $post_follower[1]['immagine_post'];?>" class="immagine_articolo">
                        <div class="container-fluid">
                        <span style="display:block;font-weight:bold;margin-bottom:6px;"><?php echo $post_follower[1]["titolo_post"] . ' by ' . $post_follower[1]["utente_seguito"];?></span>
                        <a class="anchor-lista" href="./post_view.php?article=<?php echo $post_follower[1]['id'];?>"><?php echo $post_follower[1]["descrizione_post"];?></a>
                        </div>
                    </li>
                    <li class="elemento_lista">
                        <img src="data:image/jpg;charset=utf8;base64,<?php echo $post_follower[2]['immagine_post'];?>" class="immagine_articolo">
                        <div class="container-fluid">
                        <span style="display:block;font-weight:bold;margin-bottom:6px;"><?php echo $post_follower[2]["titolo_post"] . ' by ' . $post_follower[2]["utente_seguito"];?></span>
                        <a class="anchor-lista" href="./post_view.php?article=<?php echo $post_follower[2]['id'];?>"><?php echo $post_follower[2]["descrizione_post"];?></a>
                        </div>
                    </li>
                    <li class="elemento_lista">
                        <img src="data:image/jpg;charset=utf8;base64,<?php echo $post_follower[3]['immagine_post'];?>" class="immagine_articolo">
                        <div class="container-fluid">
                        <span style="display:block;font-weight:bold;margin-bottom:6px;"><?php echo $post_follower[3]["titolo_post"] . ' by ' . $post_follower[3]["utente_seguito"];?></span>
                        <a class="anchor-lista" href="./post_view.php?article=<?php echo $post_follower[3]['id'];?>"><?php echo $post_follower[3]["descrizione_post"];?></a>
                        </div>
                    </li>
                    <li class="elemento_lista">
                        <img src="data:image/jpg;charset=utf8;base64,<?php echo $post_follower[4]['immagine_post'];?>" class="immagine_articolo">
                        <div class="container-fluid">
                        <span style="display:block;font-weight:bold;margin-bottom:6px;"><?php echo $post_follower[4]["titolo_post"] . ' by ' . $post_follower[4]["utente_seguito"];?></span>
                        <a class="anchor-lista" href="./post_view.php?article=<?php echo $post_follower[4]['id'];?>"><?php echo $post_follower[4]["descrizione_post"];?></a>
                        </div>
                    </li>
                    <li class="elemento_lista">
                        <img src="data:image/jpg;charset=utf8;base64,<?php echo $post_follower[5]['immagine_post'];?>" class="immagine_articolo">
                        <div class="container-fluid">
                        <span style="display:block;font-weight:bold;margin-bottom:6px;"><?php echo $post_follower[5]["titolo_post"] . ' by ' . $post_follower[5]["utente_seguito"];?></span>
                        <a class="anchor-lista" href="./post_view.php?article=<?php echo $post_follower[5]['id'];?>"><?php echo $post_follower[5]["descrizione_post"];?></a>
                        </div>
                    </li>
                    <li class="elemento_lista">
                        <img src="data:image/jpg;charset=utf8;base64,<?php echo $post_follower[6]['immagine_post'];?>" class="immagine_articolo">
                        <div class="container-fluid">
                        <span style="display:block;font-weight:bold;margin-bottom:6px;"><?php echo $post_follower[6]["titolo_post"] . ' by ' . $post_follower[6]["utente_seguito"];?></span>
                        <a class="anchor-lista" href="./post_view.php?article=<?php echo $post_follower[6]['id'];?>"><?php echo $post_follower[6]["descrizione_post"];?></a>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <footer class="footer_top_g">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h4>About Us</h4>
                    <p id="parag_anim"> On MusicNews™ you're getting only the most interesting and relevant news on the
                        world's most
                        famous
                ...
                <div class="col-md-3">
                    <h4>Contact Us</h4>
                    <ul>
                        <li><i class="fas fa-map-marker-alt"></i>156 Via del Colosseo, Roma, Italia</li>
                        <li><i class="fas fa-envelope"></i>museek@gmail.com</li>
                        <li><i class="fas fa-phone"></i>+3396499372</li>
                    </ul>
                </div>
            </div>

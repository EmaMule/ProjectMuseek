            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                ...
                <div class="search-bar" id="search_bar">
                    <input type="text" class="search-bar-text" placeholder="Search anything" id="Search_input"
                        autocomplete="off" onkeyup="showHint_post(this.value,'<?php echo $id ?>')" />
    ...
    <div class="container container_articolo">
        ...
        <div class="container container-commenta">
            ...
            <form action="../php-function/upload_comment.php" class="form-commento" method="POST" id="form_top_g">
                <input class="commenta-textfield" id="comment-text" type="textfield" placeholder="Comment here" autocomplete="off">

    ...
    <div id="search_results" class="d-flex align-items-center"></div>
        ...
        <div class="container container_articolo">
            ...
            <div class="articolo">
                ...
                <i id="btn-like" class="fa-solid fa-thumbs-up like_button" onclick="LikeUpdate('<?php echo $id; ?>', '<?php echo $autore;?>', '<?php echo $utente;?>');"></i>
                <span id='likecount'><?php echo"$numlikes"; ?></span>

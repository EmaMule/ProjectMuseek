...
$query = "SELECT count(*) as valore,data FROM articolo WHERE utente=$1 GROUP BY data ORDER BY data";

// Esecuzione della query
$result = pg_query_params($dbconn, $query, array($email_user));

// Array per i valori e le date
$valori = array();
$date = array();

// Loop attraverso i risultati della query e popolamento degli array
            ...
            <div class="row">
              <div class="col mt-5" id="colonna_elementi">
                <div class='row justify-content-center mt-5'>
                  <button type='button' id='btn-follow' class='btn follow_button'
                    onclick="FollowUpdate('<?php echo $me; ?>','<?php echo $email_user; ?>');"><?php echo $value_button; ?></button>
                </div>

...
if($order == 'forward'){
    ...
    $num_articoli = intval($line['numarticoli']);
    $end_index = $num_articoli % 20 === 0 ? $num_articoli / 20 : floor($num_articoli / 20); 
    ...
    $num_articoli = intval($line['numarticoli']);
    $index = $num_articoli % 20 === 0 ? $num_articoli / 20 : floor($num_articoli / 20); 
